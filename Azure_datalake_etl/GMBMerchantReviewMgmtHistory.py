...
def mysqlconnect():
    ...
    toCSV = []
    try:
        cursor.execute("SELECT * FROM [DL_Gonukkad].[dbo].[GMBMerchantReviewMgmtHistory]")
...
new_directory = os.path.join(os.getcwd(), 'gon_merchant_review_mgmt_history_responses')
...
yesterday_filename = 'GMBMerchantReviewMgmtHistory_'+yesterday.strftime("%Y-%m-%d")+".csv"
rows = mysqlconnect()
...
def upload_to_bucket(blob_name, path_to_file, bucket_name):
    ...
    folder_name = 'live/GMBMerchantReviewMgmtHistory/'
...
upload_to_bucket('live/GMBMerchantReviewMgmtHistory/'+yesterday_filename,csv_file_path,'bucket_name')
...
source_table = 'gonukkad.temp_Live_Merchant_Review_Mgmt_History'
destination_table = 'gonukkad.Live_Merchant_Review_Mgmt_History'
